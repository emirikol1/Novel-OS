...
```bash
git clone https://github.com/emirikol1/Novel-OS.git
cd Novel-OS
...
| [docs/WORKFLOWS.md](docs/WORKFLOWS.md) | Step-by-step writing workflows (Story Graph-first) |
| [docs/STORY_GRAPH.md](docs/STORY_GRAPH.md) | Story Graph, chapter briefs, migration, dedup |
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | System layers, pipeline, planning surfaces |
| [docs/API.md](docs/API.md) | Programmatic API for custom integrations |
| [docs/TIMELINE.md](docs/TIMELINE.md) | Timeline events |
| [docs/RELATIONSHIPS.md](docs/RELATIONSHIPS.md) | Relationship graph and genealogy |
| [docs/BLUEPRINT.md](docs/BLUEPRINT.md) | Read-only plot canvas |
| [docs/RESEARCH.md](docs/RESEARCH.md) | Research sparks board |
| [docs/MAPS.md](docs/MAPS.md) | Map images and pins |
| [docs/PORTRAITS.md](docs/PORTRAITS.md) | Character portrait uploads |
| [docs/PROMPTS.md](docs/PROMPTS.md) | Prompt presets and safe customization |
