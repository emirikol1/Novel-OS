...
_JOB_KIND_LABELS: Dict[str, str] = {
    ...
    "redraft_from_brief": "Redraft from brief",
    "expand_placeholders": "Expand placeholders",
    "format_paragraphs": "AI Paragraphs",
    "check_dialogue_quotes": "Check dialogue quotes",
    "align_boundary": "Fix chapter alignment",
    "generate_outline": "Generate outline",
    "chapter_brief": "Generate chapter brief",
    "chapter_briefs": "Populate chapter briefs",
    "chapter_titles": "Auto-title chapters",
    "batch_extract_outlines": "Extract all outlines",
    "batch_extract_codex": "Extract all codex",
    "landed_beats": "Extract landed beats",
}
...
_SCREEN_BY_KIND: Dict[str, str] = {
    ...
    "extract": "Chapter",
    "regenerate": "Chapter",
    "redraft_from_brief": "Chapter",
    "expand_placeholders": "Chapter",
    "format_paragraphs": "Chapter",
    "check_dialogue_quotes": "Chapter",
    "align_boundary": "Chapter",
    "generate_outline": "Chapter",
    "chapter_brief": "Chapter",
    "chapter_briefs": "Dashboard",
    "chapter_titles": "Dashboard",
    "batch_extract_outlines": "Dashboard",
    "batch_extract_codex": "Dashboard",
    "landed_beats": "Chapter",
