...
const HELP_TOPICS: Record<string, {
  ...
  cast: {
    ...
    workflow: [
      ...
      "Use Relationships to label links such as rival, mentor, mother, spouse, or ally.",
      "Upload portraits only as display references.",
    ],
    examples: [
      "Before planning a betrayal scene, label one character as mentor and another as rival.",
    ...
    boundaries: [
      ...
      "Family tree labels are heuristic because relationships are stored as free text.",
  ...
  relationships: {
    ...
    purpose: "Use Relationships to see the social graph and Family Tree to view parent, child, sibling, spouse, and guardian-style labels.",
    workflow: [
      "Edit labels in Cast by opening a character.",
      "Use free-text labels for social graph edges.",
      "Use family-like labels when you want them to appear in Family Tree.",
      "Click nodes or names to return to the character editor.",
    ],
    examples: [
      "Label Mira -> Elias as mother to show a parent link.",
      "Label Lena -> Dax as rival to show it in Relationships without forcing genealogy.",
      "Use guardian or adopted labels for nontraditional family links.",
    ],
    boundaries: [
      "The graph does not infer inverse links automatically.",
      "Unusual labels may not appear in Family Tree.",
      "Relationship suggestions from prose are not automatic.",
    ],
