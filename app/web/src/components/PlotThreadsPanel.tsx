...
export default function PlotThreadsPanel({
  ...
  async function generateDescription(threadId: string) {
    ...
    try {
      ...
      if (isJobCancelledError(e)) toast("Cancelled", "success");
    ...
    <div>
      ...
      {order.length === 0 ? (
        <div className="rounded-lg border border-dashed border-paper-line bg-paper-card/60 px-6 py-8 text-center text-[13px] text-ink-muted">
          No plot threads yet.{" "}
          <ToolTip id="codex.addPlotThread" className="inline">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 px-2 py-1.5">
                  <ToolTip id="codex.plotThreadReorder">
                    <button
                      type="button"
                      draggable
                  ...
                  <ToolTip id="codex.plotThreadExpand" className="min-w-0 flex-1">
                    <button
                      type="button"
                  ...
                  <ToolTip id="codex.plotThreadExpand">
                    <button
                      type="button"
                      onClick={() => toggleExpand(t.id)}
                  ...
                  <div className="space-y-2 border-t border-paper-line/70 px-2 pb-2 pt-2">
                    ...
                    <section className="rounded-lg border border-amber/30 bg-amber/5 p-2.5">
                      ...
                      <textarea
                        ...
                        rows={2}
                      />
                      <ToolTip id="codex.plotGenerateSummary">
                      <ToolTip id="codex.plotGenerateSummary">
                        <button
                          type="button"
