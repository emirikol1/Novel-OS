    ...
    <Modal open={open} onClose={handleDismiss} title={title}>
      ...
      {kind === "plot_thread" && (
        <div className="mb-4 flex gap-2">
          <ToolTip id="codex.mergePlotsParallel">
            <button
              type="button"
          ...
          <ToolTip id="codex.mergePlotsNest">
            <button
              type="button"
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="flex justify-end gap-3">
            <ToolTip id={cancelLabel === "Back" ? "modal.cancel" : "modal.cancel"}>
              <button
                type="button"
            ...
            <ToolTip id={kind === "character" ? "codex.mergeCharactersManual" : plotMergeMode === "nest" ? "codex.mergePlotsNest" : "codex.mergePlotsParallel"}>
              <button
                type="button"
                onClick={merge}
