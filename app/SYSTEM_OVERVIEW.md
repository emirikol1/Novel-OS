...
- **Story bible** — durable canon: genre, themes, setting facts, world rules, stable relationship facts
- **Characters** — desires, fears, arcs, knowledge, possessions, current location, emotional state, last appearance
- **Story graph / plot threads** — structural arcs, subplots, dependencies, character-to-plot links
...
- **Chapter briefs / landed beats** — per-chapter prompt focus and chapter-local events extracted from prose; not automatic Story Bible canon
- **Timeline** — chronological event log
- **Style profile** — authoritative writing tone, POV, tense, prose style, sentence-length targets, vocabulary level, ratios
